...
//            ->addOption('uglifyjs-bin',false, InputOption::VALUE_OPTIONAL, 'uglifyjs binary', ''+$this->getContainer()->getParameter('avanzu_admin_theme.uglifyjs_bin'))
//             ->addOption('uglifycss-bin', false, InputOption::VALUE_OPTIONAL, 'uglifycss binary', ''+$this->getContainer()->getParameter('avanzu_admin_theme.uglifycss_bin'))
        ;
