...
//        $uglifycss = $this->getContainer()->getParameter('avanzu_admin_theme.uglifycss_bin');
//        $process = new Process(sprintf($uglifycss+' %s > %s', implode(' ', $files), $script));
...
//        $uglifyjs  = $this->getContainer()->getParameter('avanzu_admin_theme.uglifyjs_bin');
//        $process = new Process(sprintf($uglifyjs+' %s -c -m -o %s', implode(' ', $files), $script));
